"""Smoke validation for tslanet_joint training (no architecture changes).
...
Usage:
  uv run python validate_tslanet_smoke.py
"""
...
from src.models.tslanet import TSLANetConfig, TSLANetHeartRateModel, count_parameters
...
def main() -> None:
    ...
    cfg = TSLANetConfig(channel_mode="joint")  # use_frequency_domain defaults False
    model = TSLANetHeartRateModel(cfg).to(DEVICE)
